...
class SqliteParser extends ParserBase
{
    /**
    ...
    {
        // $tables = DB::select("SELECT * FROM sqlite_master ORDER BY name;");
        return DB::select("PRAGMA table_info({$this->tableName});");
    }
    ...
    protected function getTransfredFields(array $columns)
    {
        ...
        foreach ($columns as $column) {
            ...
            $properties['is-nullable'] = ($column->notnull == '0');
            $properties['data-value'] = $column->dflt_value;
            ...
            $properties['is-primary'] = ($column->pk == '1');
